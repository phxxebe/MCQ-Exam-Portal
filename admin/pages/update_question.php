                ...
                <div class="report">
                    ...
                    <form method="post" action="" class="forms" enctype="multipart/form-data">
                        ...
                        <select name="category">
                            <option <?php if($category=="English"){echo "selected='seleccted'";} ?> value="English">Theory</option>
                            <option  <?php if($category=="Math"){echo "selected='seleccted'";} ?> value="Math">Practical</option>
                        </select>
                        <br />
