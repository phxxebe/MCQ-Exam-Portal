            ...
            <div class="content">
                <div class="report">
                    ...
                    <form method="post" action="" class="forms">
                        ...
                        <input type="text" name="faculty_name" placeholder="Test Title" required="true" /> <br />
                        ...
                        <span class="name">Total Theory Questions</span>
                        <input type="number" name="total_english_qns" placeholder="Total Number of Theory Questions" required="true" /><br />
                        
                        <span class="name">Total Practical Questions</span>
                        <input type="number" name="total_math_qns" placeholder="Total Number of Practical Questions" /><br />
                        ...
                        <input type="submit" name="submit" value="Add Test" class="btn-add" style="margin-left: 15%;" />
                    ...
                    <?php 
                        if(isset($_POST['submit']))
                        {
                            ...
                            {
                                $_SESSION['validation']="<div class='error'>Test name or Time Duration or Question Per Page is Empty.</div>";
                            ...
                            {
                                //Success Message
                                $_SESSION['add']="<div class='success'>New test successfully added.</div>";
                                header('location:'.SITEURL.'admin/index.php?page=faculties');
                            }
                            else
                            {
                                //FAil Message
                                $_SESSION['add']="<div class='error'>Failed to add new test. Try again.</div>";
                                header('location:'.SITEURL.'admin/index.php?page=add_faculty');
                            }
                        }
                    ?>
