            ...
            <div class="content">
                <div class="report">
                    ...
                    <form method="post" action="" class="forms">
                        ...
                        <input type="submit" name="submit" value="Update Test" class="btn-update" style="margin-left: 15%;" />
                    ...
                    <?php 
                        if(isset($_POST['submit']))
                        {
                            ...
                            if($res===true)
                            {
                                $_SESSION['update']="<div class='success'>Test successfully updated.</div>";
                                header('location:'.SITEURL.'admin/index.php?page=faculties');
                            }
                            else
                            {
                                $_SESSION['update']="<div class='error'>Failed to update test. Please try again.</div>";
